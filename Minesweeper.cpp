...
Depreciated Now Because it relies heavily on Conio.h for wherex(),wherey(),gotoxy()
functions, Although it still will work in Turbo C++ Compilers(We were bound to use it)
...
gotoxy(xpos,ypos);textcolor(2);
gotoxy(xpos,wherey()+1);cprintf("/////////////////////////////////////////////////////////////");
gotoxy(xpos,wherey()+1);cprintf("//");textcolor(c1);cprintf("            ");textcolor(c2);cprintf("       ");textcolor(c3);cprintf("       ");textcolor(c4);cprintf("       ");textcolor(c5);cprintf("        ");textcolor(c6);cprintf("          ");textcolor(c7);cprintf("      ");textcolor(2);cprintf("//");
gotoxy(xpos,wherey()+1);cprintf("//");textcolor(c1);cprintf("  11    11");textcolor(c2);cprintf("  11111");textcolor(c3);cprintf("  11   ");textcolor(c4);cprintf("  11111");textcolor(c5);cprintf("  111111");textcolor(c6);cprintf("  111  111");textcolor(c7);cprintf(" 11111");textcolor(2);cprintf("  //");
gotoxy(xpos,wherey()+1);cprintf("//");textcolor(c1);cprintf("  11    11");textcolor(c2);cprintf("  11   ");textcolor(c3);cprintf("  11   ");textcolor(c4);cprintf("  11   ");textcolor(c5);cprintf("  11  11");textcolor(c6);cprintf("  111  111");textcolor(c7);cprintf(" 11   ");textcolor(2);cprintf("  //");
gotoxy(xpos,wherey()+1);cprintf("//");textcolor(c1);cprintf("  11    11");textcolor(c2);cprintf("  11   ");textcolor(c3);cprintf("  11   ");textcolor(c4);cprintf("  11   ");textcolor(c5);cprintf("  11  11");textcolor(c6);cprintf("  11 11 11");textcolor(c7);cprintf(" 11   ");textcolor(2);cprintf("  //");
gotoxy(xpos,wherey()+1);cprintf("//");textcolor(c1);cprintf("  11    11");textcolor(c2);cprintf("  11111");textcolor(c3);cprintf("  11   ");textcolor(c4);cprintf("  11   ");textcolor(c5);cprintf("  11  11");textcolor(c6);cprintf("  11    11");textcolor(c7);cprintf(" 11111");textcolor(2);cprintf("  //");
gotoxy(xpos,wherey()+1);cprintf("//");textcolor(c1);cprintf("  11 11 11");textcolor(c2);cprintf("  11   ");textcolor(c3);cprintf("  11   ");textcolor(c4);cprintf("  11   ");textcolor(c5);cprintf("  11  11");textcolor(c6);cprintf("  11    11");textcolor(c7);cprintf(" 11   ");textcolor(2);cprintf("  //");
gotoxy(xpos,wherey()+1);cprintf("//");textcolor(c1);cprintf("  111  111");textcolor(c2);cprintf("  11   ");textcolor(c3);cprintf("  11   ");textcolor(c4);cprintf("  11   ");textcolor(c5);cprintf("  11  11");textcolor(c6);cprintf("  11    11");textcolor(c7);cprintf(" 11   ");textcolor(2);cprintf("  //");
gotoxy(xpos,wherey()+1);cprintf("//");textcolor(c1);cprintf("  111  111");textcolor(c2);cprintf("  11111");textcolor(c3);cprintf("  11111");textcolor(c4);cprintf("  11111");textcolor(c5);cprintf("  111111");textcolor(c6);cprintf("  11    11");textcolor(c7);cprintf(" 11111");textcolor(2);cprintf("  //");
gotoxy(xpos,wherey()+1);cprintf("//");textcolor(2);cprintf("                                                         //");textcolor(2);
gotoxy(xpos,wherey()+1);cprintf("/////////////////////////////////////////////////////////////");textcolor(2);
gotoxy(xpos,wherey()+1);cprintf("//                                                         //");textcolor(2);
gotoxy(xpos,wherey()+1);cprintf("//          ");textcolor(RED);cprintf("      PRESS ANY KEY TO CONTINUE    ");textcolor(2);cprintf("            //");textcolor(2);
gotoxy(xpos,wherey()+1);cprintf("//                                                         //");textcolor(2);
gotoxy(xpos,wherey()+1);cprintf("/////////////////////////////////////////////////////////////");textcolor(2);
getch();
textcolor(GREEN);
...
{
{
    ...
    ofstream initial("highscore.sys",ios::binary|ios::noreplace);
	...
	else if(chi==0)
	{
	    ...
	    gotoxy(12,9);textcolor(BLUE+RED);cprintf("HOW TO MOVE");textcolor(YELLOW);
